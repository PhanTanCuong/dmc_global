            ...
            <form action="customBanner" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group">
                        <label>Title</label>
                        <textarea type="text" name="banner_title" class="form-control" placeholder="Enter Title"><?php echo $row['title']; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label>Description</label>
                        <textarea type="text" name="banner_description" class="form-control" placeholder="Enter Description"><?php echo $row['description']; ?></textarea>
                    </div>
                    <div class="form-group">
